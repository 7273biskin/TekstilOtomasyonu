...
namespace Tekstil
{
    public partial class SiparisDetay3 : Form
    {
        public SiparisDetay3()
        {
            InitializeComponent();
        }
        ...
        DataSet ds;
        private void SiparisDetay3_Load(object sender, EventArgs e)
        {
            Doldur();
